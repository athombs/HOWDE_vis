...
foil:`
	...
	<div class="panel">
		...
		This oblique shock (Mach wave) has a wave angle of roughly 40 degrees and is formed by the deflection of the flow around a lifted boundary layer.
	</div>
	<button class="accordion">Grid</button>
	<div class="panel">
		Multiblock: 5 blocks<br>
...
<button class="accordion">Case Description</button>
<div class="panel">
Kelvin–Helmholtz instability generated by a perturbed shear layer.
</div>
...
<button class="accordion">Physics Model</button>
<div class="panel">
Multispecies reacting flow with vibrational nonequilibrium.
</div>

<button class="accordion">Species</button>
<div class="panel">
N2, O2, NO, N, O
</div>
...
else if (sim === "lowbubble") title = "Low-Density Bubble Impact (2D)";
else if (sim === "highbubble") title = "High-Density Bubble Impact (2D)";
